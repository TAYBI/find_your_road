  ...
  return (function t(e, r, n) {
  ...
  })(
    {
        ...
        function (e, t) {
          ...
          function r(e, t) {
            return (
              ...
              function r(n, s) {
                return n
                  ? ((s = s.source || s), (e = e.replace(n, s)), r)
                  : new RegExp(e, t);
              }
            );
          }
          var n = /[a-zA-Z_:][a-zA-Z0-9:._-]*/,
            ...
            o = /'[^']*'/,
            i = /"[^"]*"/,
            l = r(/(?:unquoted|single_quoted|double_quoted)/)("unquoted", s)(
              "single_quoted",
              o
            )("double_quoted", i)(),
            a = r(/(?:\s+attr_name(?:\s*=\s*attr_value)?)/)("attr_name", n)(
              "attr_value",
              l
            )(),
            ...
            )("open_tag", c)("close_tag", u)("comment", p)("processing", h)(
              "declaration",
              f
            )("cdata", d)();
          ...
          t.exports = function (e, t) {
            ...
            if (60 === e.src.charCodeAt(t)) {
              for (t++; a > t; ) {
                ...
                if (62 === s)
                  return (
                    (i = r(n(e.src.slice(l + 1, t)))),
                    e.parser.validateLink(i)
                      ? ((e.pos = t + 1), (e.linkContent = i), !0)
                      : !1
                  );
                92 === s && a > t + 1 ? (t += 2) : t++;
              }
            ...
            return l === t
              ...
              : ((i = n(e.src.slice(l, t))),
                e.parser.validateLink(i)
                  ? ((e.linkContent = i), (e.pos = t), !0)
                  : !1);
          };
        },
        { "../common/utils": 5, "./normalize_link": 9 },
      ],
      12: [
        function (e, t) {
          "use strict";
          ...
          t.exports = function (e, t) {
            ...
            for (t++, 40 === i && (i = 41); o > t; ) {
              if (((n = e.src.charCodeAt(t)), n === i))
                return (
                  (e.pos = t + 1),
                  (e.linkContent = r(e.src.slice(s + 1, t))),
                  !0
                );
              92 === n && o > t + 1 ? (t += 2) : t++;
            }
          ...
          r.prototype.tokenize = function (e, t, r) {
            for (
              var n,
                ...
                a = !1;
              r > l &&
              ((e.line = l = e.skipEmptyLines(l)), !(l >= r)) &&
              ...
              if (
                ...
                if (
                  ((a = !0),
                  l++,
                  r > l && "list" === e.parentType && e.isEmpty(l))
                )
                  break;
                e.line = l;
              }
          ...
          (r.prototype.parse = function (e, t, r, n) {
            ...
            return e
              ? ((e = e.replace(a, " ")),
                ...
                void this.tokenize(o, o.line, o.lineMax))
              : [];
          }),
            (t.exports = r);
        },
      ...
      17: [
        function (e, t) {
          ...
          function n(e) {
            ...
            return (
              (r = i.replaceEntities(r)),
              -1 !== r.indexOf(":") && -1 !== t.indexOf(r.split(":")[0])
                ? !1
                : !0
            );
          }
      ...
      18: [
        function (e, t) {
          ...
          var n = e("./common/utils"),
            s = e("./rules");
          (t.exports = r),
            (r.prototype.renderInline = function (e, t, r) {
            ...
            (r.prototype.render = function (e, t, r) {
              for (var n = this.rules, s = e.length, o = -1, i = ""; ++o < s; )
                i +=
                  "inline" === e[o].type
                    ? this.renderInline(e[o].children, t, r)
                    : n[e[o].type](e, o, t, r, this);
              return i;
            });
        },
        { "./common/utils": 5, "./rules": 20 },
      ],
      19: [
        function (e, t) {
          "use strict";
      ...
      20: [
        function (e, t) {
          ...
          (l.blockquote_open = function () {
            ...
            (l.code = function (e, t) {
              return e[t].block
                ? "<pre><code>" + i(e[t].content) + "</code></pre>" + a(e, t)
                : "<code>" + i(e[t].content) + "</code>";
            }),
            (l.fence = function (e, t, r, l, c) {
              ...
              if (f.params) {
                if (
                  ((u = f.params.split(/\s+/g)),
                  (p = u.join(" ")),
                  n(c.rules.fence_custom, u[0]))
                )
                  return c.rules.fence_custom[u[0]](e, t, r, l, c);
                (m = i(o(s(p)))), (d = ' class="' + g + m + '"');
              }
              return (
                (h = r.highlight
                  ? r.highlight.apply(r.highlight, [f.content].concat(u)) ||
                    i(f.content)
                  : i(f.content)),
                "<pre><code" + d + ">" + h + "</code></pre>" + a(e, t)
              );
            }),
            (l.fence_custom = {}),
          ...
          t.exports = function (e, t, r, n) {
            ...
            for (
              32 === e.src.charCodeAt(g) && g++,
                ...
                s = t + 1;
              r > s &&
              ((g = e.bMarks[s] + e.tShift[s]), (m = e.eMarks[s]), !(g >= m));
              s++
            )
      ...
      23: [
        function (e, t) {
          ...
          function r(e, t) {
            ...
            return s >= o
              ? -1
              : ((n = e.src.charCodeAt(s++)),
                126 !== n && 58 !== n
                  ? -1
                  : ((r = e.skipSpaces(s)), s === r ? -1 : r >= o ? -1 : r));
          }
          function n(e, t) {
            var r,
              n,
            ...
            e: for (;;) {
              for (
                ...
                if (
                  ...
                  (m = e.tShift[l]),
                  (g = e.parentType),
                  (e.blkIndent = e.ddIndent = e.tShift[l] + 2),
                  (e.tShift[l] = i - e.bMarks[l]),
                  (e.tight = !0),
                  (e.parentType = "deflist"),
                  e.parser.tokenize(e, l, s, !0),
                  (!e.tight || v) && (k = !1),
                  (v = e.line - l > 1 && e.isEmpty(e.line - 1)),
                  (e.tShift[l] = m),
                  (e.tight = b),
                  (e.parentType = g),
                  (e.blkIndent = f),
        ...
        function (e, t) {
          ...
          t.exports = function (e, t, r, n) {
            ...
            for (
              l = t;
              (l++, !(l >= r)) &&
              ((u = a = e.bMarks[l] + e.tShift[l]),
              (p = e.eMarks[l]),
              !(p > u && e.tShift[l] < e.blkIndent));

            )
              if (
                e.src.charCodeAt(u) === s &&
                !(
                  e.tShift[l] - e.blkIndent >= 4 ||
                  ((u = e.skipChars(u, s)),
                  o > u - a || ((u = e.skipSpaces(u)), p > u))
                )
              ) {
                c = !0;
                break;
        ...
        function (e, t) {
          ...
          t.exports = function (e, t, r, n) {
            ...
            return o > 6 || (a > l && 32 !== s)
              ...
              : n
              ? !0
              : ((a = e.skipCharsBack(a, 32, l)),
                (i = e.skipCharsBack(a, 35, l)),
                i > l && 32 === e.src.charCodeAt(i - 1) && (a = i),
                (e.line = t + 1),
                e.tokens.push({
                  type: "heading_open",
                  hLevel: o,
          ...
          t.exports = function (e, t, o, i) {
            ...
            for (
              y = e.tokens.length,
                ...
                l = t,
                x = !1,
                q = e.parser.ruler.getRules("list");
              !(
                !(o > l) ||
                ((_ = e.skipSpaces(d)),
                (g = e.eMarks[l]),
                ...
                (e.tight = !0),
                (e.parentType = "list"),
                e.parser.tokenize(e, t, o, !0),
                (!e.tight || x) && (M = !1),
                (x = e.line - t > 1 && e.isEmpty(e.line - 1)),
                (e.blkIndent = u),
                (e.tShift[t] = c),
                (e.tight = p),
                (e.parentType = h),
        ...
        function (e, t) {
          ...
          t.exports = function (e, t) {
            ...
            if (((r = e.lineMax), r > a && !e.isEmpty(a)))
              for (
                l = e.parser.ruler.getRules("paragraph");
                r > a && !e.isEmpty(a);
                a++
              )
        ...
        function (e, t) {
          ...
          (r.prototype.isEmpty = function (e) {
            ...
            (r.prototype.skipEmptyLines = function (e) {
              for (
                var t = this.lineMax;
                t > e && !(this.bMarks[e] + this.tShift[e] < this.eMarks[e]);
                e++
              );
              return e;
            }),
            ...
            (r.prototype.getLines = function (e, t, r, n) {
              ...
              for (l = new Array(t - e), s = 0; t > c; c++, s++)
                (a = this.tShift[c]),
                  ...
                  0 > a && (a = 0),
                  (o = this.bMarks[c] + a),
                  (i = t > c + 1 || n ? this.eMarks[c] + 1 : this.eMarks[c]),
                  (l[s] = this.src.slice(o, i));
              return l.join("");
            }),
            (t.exports = r);
        },
            ...
            for (
              ...
              for (
                ...
                e.tokens.push({
                  ...
                  (p = u[a]
                    .substring(
                      124 === u[a].charCodeAt(0) ? 1 : 0,
                      124 === u[a].charCodeAt(u[a].length - 1)
                        ? u[a].length - 1
                        : u[a].length
                    )
                    .trim()),
        ...
        function (e, t) {
          ...
          function r(e, t, r, o) {
            ...
            if (
              ((i = new n(e, t, r, o, [])),
              (l = s(i, 1)),
              0 > l || 58 !== e.charCodeAt(l + 1))
            )
              return -1;
            for (
              c = i.posMax, a = l + 2;
              c > a && 10 !== i.src.charCodeAt(a);
              a++
            );
            return (
              (u = e.slice(2, l)),
              (p = e.slice(l + 2, a).trim()),
              0 === p.length
                ? -1
                : (o.abbreviations || (o.abbreviations = {}),
                  "undefined" == typeof o.abbreviations[":" + u] &&
                    (o.abbreviations[":" + u] = p),
                  a)
            );
          }
              ...
              for (t = 1, n = i.length - 1; n > t; t++)
                if (
                  ...
                  for (
                    s = i[t].content;
                    s.length &&
                    ((o = r(s, e.inline, e.options, e.env)), !(0 > o));

                  )
                    s = s.slice(o).trim();
                  (i[t].content = s),
                    s.length || ((i[t - 1].tight = !0), (i[t + 1].tight = !0));
                }
          };
        },
        {
                    ...
                    if (((l = i[t]), "text" === l.type)) {
                      for (
                        ...
                        h.lastIndex > u &&
                          ...
                          c.push({ type: "text", content: f[2], level: p }),
                          c.push({ type: "abbr_close", level: --p }),
                ...
                for (
                  e.tokens.push({ type: "footnote_open", id: t, level: u++ }),
                    i[t].tokens
                      ...
                      : i[t].label && (l = h[":" + i[t].label]),
                    e.tokens = e.tokens.concat(l),
                    o =
                ...
                if ("inline" === v[o].type)
                  for (a = v[o].children, g = 0, t = a.length - 1; t >= 0; t--)
                    if (((c = a[t]), "link_close" !== c.type)) {
                      if (
                        ("htmltag" === c.type &&
                          (r(c.content) && g > 0 && g--, n(c.content) && g++),
                        !(g > 0) && "text" === c.type && i.test(c.content))
                      ) {
                        if (
                          (k || ((k = s()), (m = k.links), (b = k.autolinker)),
                          (u = c.content),
                          (m.length = 0),
                          b.link(u),
                          !m.length)
                        ...
                        for (p = [], d = c.level, h = 0; h < m.length; h++)
                          e.inline.validateLink(m[h].url) &&
                            ((f = u.indexOf(m[h].text)),
                            f &&
                              ((d = d),
                              p.push({
                                type: "text",
                            ...
                            p.push({ type: "link_close", level: --d }),
                            (u = u.slice(f + m[h].text.length)));
                        u.length &&
                          p.push({ type: "text", content: u, level: d }),
                          (v[o].children = a = [].concat(
                            a.slice(0, t),
                            p,
                            a.slice(t + 1)
                          ));
        ...
        function (e, t) {
          ...
          function r(e, t, r, a) {
            ...
            if (
              ((c = new n(e, t, r, a, [])),
              (u = s(c, 0)),
              0 > u || 58 !== e.charCodeAt(u + 1))
            )
              return -1;
            for (
              h = c.posMax, p = u + 2;
              h > p && ((f = c.src.charCodeAt(p)), 32 === f || 10 === f);
              p++
            );
            if (!o(c, p)) return -1;
            for (
              g = c.linkContent, p = c.pos, d = p, p += 1;
              h > p && ((f = c.src.charCodeAt(p)), 32 === f || 10 === f);
              p++
            );
            for (
              h > p && d !== p && i(c, p)
                ...
                : ((m = ""), (p = d));
              h > p && 32 === c.src.charCodeAt(p);

            )
              p++;
            return h > p && 10 !== c.src.charCodeAt(p)
              ? -1
              : ((b = l(e.slice(1, u))),
                "undefined" == typeof a.references[b] &&
                  (a.references[b] = { title: m, href: g }),
                p);
          }
          var n = e("../rules_inline/state_inline"),
            s = e("../helpers/parse_link_label"),
            ...
            if (e.options.typographer)
              for (x = [], _ = e.tokens.length - 1; _ >= 0; _--)
                if ("inline" === e.tokens[_].type)
                  for (
                    y = e.tokens[_].children, x.length = 0, t = 0;
                    t < y.length;
                    t++
                  )
                    if (((i = y[t]), "text" === i.type && !s.test(i.text))) {
                      for (
                        h = y[t].level, v = x.length - 1;
                        v >= 0 && !(x[v].level <= h);
                        v--
                      );
                      (x.length = v + 1),
      ...
      43: [
        ...
        { "../common/url_schemas": 4, "../helpers/normalize_link": 9 },
      ],
      44: [
        function (e, t) {
          "use strict";
          t.exports = function (e, t) {
            ...
            for (
              r = l, l++, n = e.posMax;
              n > l && 96 === e.src.charCodeAt(l);

            )
              l++;
            for (
              s = e.src.slice(r, l), o = i = l;
              -1 !== (o = e.src.indexOf("`", i));
      ...
      45: [
        function (e, t) {
          ...
          t.exports = function (e, t) {
            ...
            if (e.level >= e.options.maxNesting) return !1;
            if (
              ((o = a > 0 ? e.src.charCodeAt(a - 1) : -1),
              (i = e.src.charCodeAt(a + 2)),
              126 === o)
            )
              return !1;
            if (126 === i) return !1;
            ...
            if (n > a + 3)
              return (
                (e.pos += n - a), t || (e.pending += e.src.slice(a, n)), !0
              );
            for (e.pos = a + 2, s = 1; e.pos + 1 < l; ) {
              if (
                ...
                (i = e.pos + 2 < l ? e.src.charCodeAt(e.pos + 2) : -1),
                126 !== i &&
                  126 !== o &&
                  (32 !== o && 10 !== o ? s-- : 32 !== i && 10 !== i && s++,
                  0 >= s))
              ) {
                r = !0;
                break;
        ...
        function (e, t) {
          ...
          function n(e, t) {
            ...
            return (
              ...
              o >= 4
                ? (l = a = !1)
                : ((s = c > i ? e.src.charCodeAt(i) : -1),
                  (32 === s || 10 === s) && (l = !1),
                  (32 === n || 10 === n) && (a = !1),
                  95 === u && (r(n) && (l = !1), r(s) && (a = !1))),
              { can_open: l, can_close: a, delims: o }
            );
          }
          t.exports = function (e, t) {
            var r,
            ...
            if (((c = n(e, p)), (r = c.delims), !c.can_open))
              return (
                (e.pos += r), t || (e.pending += e.src.slice(p, e.pos)), !0
              );
            if (e.level >= e.options.maxNesting) return !1;
          ...
          "\\!\"#$%&'()*+,./:;<=>?@[]^_`{|}~-".split("").forEach(function (e) {
            ...
            (t.exports = function (e, t) {
              ...
              if ((s++, o > s)) {
                ...
                if (10 === n) {
                  for (
                    t || e.push({ type: "hardbreak", level: e.level }), s++;
                    o > s && 32 === e.src.charCodeAt(s);
        ...
        function (e, t) {
          ...
          t.exports = function (e, t) {
            ...
            return n === l + 2
              ...
              ? !1
              : (n++,
                (r = e.src.slice(l + 2, n - 1)),
                "undefined" == typeof e.env.footnotes.refs[":" + r]
                  ? !1
                  : (t ||
                      (e.env.footnotes.list || (e.env.footnotes.list = []),
                      e.env.footnotes.refs[":" + r] < 0
                        ? ((s = e.env.footnotes.list.length),
                          (e.env.footnotes.list[s] = { label: r, count: 0 }),
                          (e.env.footnotes.refs[":" + r] = s))
                        : (s = e.env.footnotes.refs[":" + r]),
        ...
        function (e, t) {
          ...
          t.exports = function (e, t) {
            ...
            return e.options.html
              ? ((i = e.posMax),
                60 !== e.src.charCodeAt(l) || l + 2 >= i
                  ? !1
                  : ((s = e.src.charCodeAt(l + 1)),
                    (33 === s || 63 === s || 47 === s || r(s)) &&
        ...
        function (e, t) {
          ...
          t.exports = function (e, t) {
            ...
            if (((p = l + 1), m > p && 40 === e.src.charCodeAt(p))) {
              for (
                p++;
                m > p && ((f = e.src.charCodeAt(p)), 32 === f || 10 === f);
                p++
              );
              if (p >= m) return !1;
              for (
                b = p,
                  n(e, p) ? ((c = e.linkContent), (p = e.pos)) : (c = ""),
                  b = p;
                m > p && ((f = e.src.charCodeAt(p)), 32 === f || 10 === f);
                p++
              );
              ...
              if (
                (m > p &&
                  ...
                  ((b = p + 1),
                  (p = r(e, p)),
                  p >= 0 ? (a = e.src.slice(b, p++)) : (p = b - 1)),
                a ||
                  ("undefined" == typeof a && (p = l + 1),
                  (a = e.src.slice(i, l))),
                (h = e.env.references[o(a)]),
                !h)
              )
                return (e.pos = g), !1;
              (c = h.href), (u = h.title);
      ...
      55: [
        function (e, t) {
          ...
          t.exports = function (e, t) {
            ...
            for (s++; n > s && 32 === e.src.charCodeAt(s); ) s++;
            return (e.pos = s), !0;
          };
        },
        {},
            ...
            return (
              (e.prototype = {
                ...
                link: function (e) {
                  for (
                    ...
                    if ("element" === a)
                      "a" === l.getTagName() &&
                        (l.isClosing() ? (n = Math.max(n - 1, 0)) : n++),
                        s.push(c);
                ...
                getHtmlParser: function () {
                  ...
                  return (
                    t || (t = this.htmlParser = new e.htmlParser.HtmlParser()),
                    t
                  );
                },
              ...
              (e.Util = {
                ...
                extend: function (t, r) {
                  ...
                  s.prototype = n;
                  var o;
                  o = r.hasOwnProperty("constructor")
                    ? r.constructor
                    : function () {
              ...
              (e.htmlParser.HtmlParser = e.Util.extend(Object, {
                ...
                parse: function (e) {
                  for (
                    var t, r, n = this.htmlRegex, s = 0, o = [];
                    null !== (t = n.exec(e));
                    ...
                    c &&
                      ...
                      o.push.apply(o, r)),
                      o.push(this.createElementNode(i, l, a)),
                      (s = t.index + i.length);
                  }
                  if (s < e.length) {
                    var u = e.substring(s);
                ...
                parseTextAndEntityNodes: function (t) {
                  for (
                    ...
                    var i = n[s],
                      l = n[s + 1];
                    i && r.push(this.createTextNode(i)),
                      l && r.push(this.createEntityNode(l));
                  }
                  return r;
                },
              ...
              (e.matchParser.MatchParser = e.Util.extend(Object, {
                ...
                replace: function (e, t, r) {
                  var n = this;
                  return e.replace(this.matcherRegex, function (
                    e,
                    s,
                    o,
                    i,
                ...
                processCandidateMatch: function (t, r, n, s, o, i, l, a, c) {
                  ...
                  if (
                    ...
                    (o && !this.email) ||
                    (i && !this.urls) ||
                    !this.matchValidator.isValidMatch(i, l, p)
                  )
                    return null;
                  if (
                    ...
                    u = new e.match.Email({ matchedText: t, email: o });
                  else if (r)
                    n && ((h = n), (t = t.slice(1))),
